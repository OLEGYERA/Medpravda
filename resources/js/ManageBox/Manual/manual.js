...
import Vue from 'vue';
import DrugRoutes from './drug/router.js'
import BadRoutes from './bad/router.js'
import WareRoutes from './ware/router.js'
import CosmeticRoutes from './cosmetic/router.js'

let router;
switch (location.href.split(url + '/manage/manual/').pop().split('#')[0]) {
    case 'drug':
        router = DrugRoutes;
        break;
    case 'bad':
