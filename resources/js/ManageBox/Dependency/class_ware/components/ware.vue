    ...
    <div class="reactive-content flex-col">
        <div class="reactive-page-header flex-row-sb-c">
            <div class="header-left flex-col">
                <h1 class="reactive-title blue">Зависимости <i class="fas fa-angle-right"></i> Классификации Мед. Изделий</h1>
                <div class="reactive-sub-titles" v-if="class_wares_infoline_hidden">
                    <infoline
            ...
            <div class="header-right">
                <div class="r-btn r-lnk" @click="callback_create = !callback_create">Добавить Классификацию Мед. Изделий</div>
                <modal-create
                    :method_processed="'insert'"
                    :type_creation="'classes'"
                    :url="'dependency/class_ware/null'"
        ...
        <nav class="reactive-navigation">
            <router-link to="/" class="active blue">Все Классификации Мед.Изделий</router-link>
        </nav>
    ...
    export default {
        ...
        methods: {
            getClassWares(search_for_alias){
                HTTP.post(`class_ware/get/all?page=` + this.current_paginate, {
                    filter: this.filter,
                    ...
                    this.class_wares_infoline_hidden = [{title: response.data.class_wares.data.length, info: 'Классификаций Мед. Изделий сейчас на странице'}, {title: response.data.count, info: 'всего Классификаций Мед. Изделий в панели управления'}]
                })
            },
            deleteClassWare(id){
