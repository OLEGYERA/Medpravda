    ...
    <div class="reactive-content flex-col">
        <div class="reactive-page-header flex-row-sb-c">
            <div class="header-left flex-col">
                <h1 class="reactive-title red">Просмотр Роли <i class="fas fa-angle-right"></i> <b>{{role_data.title}}</b></h1>
            ...
            <div class="header-right flex-row">
                ...
                <router-link :to="{name: 'edit_rule', props: {alias: role_data.alais}}" class="r-btn r-circle edit"><i class="fas fa-pen"></i></router-link>
                <delete :title="'Удалить роль ' + role_data.title + '?'"
                        :mode="'page'"
                ...
                <div class="reactive-box">
                    ...
                    <ul class="box-content">
                        <li class="list-item-row">
                            <switcher :id=1 :status=role_data.administration :color="'red'" :namespace="'administration'" @toggle="switchRuleCategory" :disabled_mode=true></switcher>
                        ...
                        <li class="list-item-row">
                            <switcher :id=2 :status=role_data.moderation :color="'red'" :namespace="'moderation'" @toggle="switchRuleCategory" :disabled_mode=true></switcher>
                            <div class="item-col-data">
                        ...
                        <li class="list-item-row">
                            <switcher :id=3 :status=role_data.catalog :color="'red'" :namespace="'catalog'" @toggle="switchRuleCategory" :disabled_mode=true></switcher>
                            <div class="item-col-data">
                        ...
                        <li class="list-item-row">
                            <switcher :id=4 :status=role_data.dependency :color="'red'" :namespace="'dependency'" @toggle="switchRuleCategory" :disabled_mode=true></switcher>
                            <div class="item-col-data">
                        ...
                        <li class="list-item-row">
                            <switcher :id=5 :status=role_data.history :color="'red'" :namespace="'history'" @toggle="switchRuleCategory" :disabled_mode=true></switcher>
                            <div class="item-col-data">
                        ...
                        <li class="list-item-row">
                            <switcher :id=6 :status=role_data.gallery :color="'red'" :namespace="'gallery'" @toggle="switchRuleCategory" :disabled_mode=true></switcher>
                            <div class="item-col-data">
                ...
                <div class="reactive-box">
                    ...
                    <ul class="box-content">
                        <li class="list-item-col">
                            ...
                            <input type="text" class="r-input" v-model="role_title" @blur="updateRuleTitle" @keyup.enter="updateRuleTitle" :class="{error: role_title_error!==null}" disabled>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    export default {
        mounted() {
            console.log(location.href.split('http://localhost:3000/manage/administration/rolling').pop().split('#/edit/')[0], 555)
