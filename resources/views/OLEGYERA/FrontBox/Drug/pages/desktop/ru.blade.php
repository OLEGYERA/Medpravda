...
<script type="application/ld+json">
{
  ...
  "url": "{{ route('ru.drug', ['alias' => $drug->alias])}}",
...
<div class="full-content reactive"
    ...
    <link itemprop="mainEntityOfPage" href="{{route('ru.drug', ['alias' => $drug->alias])}}" />
    <div class="triple-wrap">
        ...
        <section class="page-content mp-anchor" id="startPage">
                    ...
                    <div class="author-info">
                        ...
                        @if($drug->creator->editor)
                            <div class="author-links">
                                ...
                                @endif
                                <link itemprop="sameAs" href="{{route('ru.editors')}}/#{{$drug->creator->id}}" />
            ...
            <div class="row-drug-presentation">
                ...
                @endif
                <h1 itemprop="headline name" class="drug-title @if($drug->setting->recipe) isRecipe @endif">{{$drug->title}}
                ...
                <div class="drug-review">
                    <div class="review-left">
                        ...
                        @if(getRatingAvarage($reviews) !== 0)<a class="under-title" href="{{route('ru.drug.review', ['alias' => $drug->alias])}}">Смотреть отзывы ({{count($reviews)}})</a>@endif
                    </div>
                ...
                <div class="drug-columns">
                    <div class="el-img">
                        <figure class="avatar">
                            <img src="{{asset('/gallery/' . getCategoryName($drug->image->category_id) . '/large/' . $drug->image->path)}}" alt="{{$drug->title}} фото, инструкция">
                        </figure>
        ...
        @include('OLEGYERA.FrontBox.MODULES.asides.desktop.ru', ['data' => $drug, 'is_mobile' => $is_mobile])
    </div>
</div>
