<div class="article {{$eclipsed?'eclipsed':''}} {{$type=='large'?'large':''}} {{$type=='mini'?'mini':''}}">
    <div class="article-body">
        <div class="img-wrapper">
            <picture>
                <img {{$type=='large' ? 'width="705" height="400"' : 'width="400" height="224"'}} src="{{$img_url}}" alt="">
            </picture>
            @if($eclipsed && $type != 'large')
        ...
        <div class="content-box">
            @if($type == 'large')
                <div class="article-info {{!$eclipsed ? 'wt-bg':''}}">
                    <div class="publish-time">
                        <span class="date">{{$time['date']}},</span>
                        <span class="time">{{$time['time']}}</span>
                    </div>
