    ...
    <div class="double-wrap">
        <div class="page-content">
            ...
            <div class="row-about">
                ...
                <p style="text-align: center"><img src="{{asset('img/FrontBox/other/brr.png')}}" alt=""></p>
                <h2 style="text-align: center">Брендирование</h2>
                <p style="text-align: center"><img src="{{asset('img/FrontBox/other/branding_ru.png')}}" alt=""></p>
                <h2 style="text-align: center">Фармвытеснение</h2>
                <p style="text-align: center"><img src="{{asset('img/FrontBox/other/full_ru.png')}}" alt=""></p>
                <hr>
                <h2 class="page-title">Контакты рекламного отдела:</h2>
                <div class="page-row">
                    <div class="part">
