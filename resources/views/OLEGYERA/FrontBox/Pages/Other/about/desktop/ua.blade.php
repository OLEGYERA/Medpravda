    ...
    <div class="double-wrap">
        <div class="page-content">
            ...
            <div class="row-about">
                ...
                <p>Мед Правда - це збірник актуальної інформації про лікарські засоби, дієтичні добавки, вироби медичного призначення та косметичні засоби, який стане в нагоді пересічному читачеві, лікарю, провізору та фармацевту.</p>
                <p>Ці ж засоби можна знайти в зручній для Вас аптеці і замовити.</p>
                <p>МедПравда - це портал про здоров'я, де Ви ознайомитеся з основними видами захворювань, симптомів та невідкладних станів. Ця інформація подана з акцентом на ознаки, які дозволять прийняти правильне рішення по відношенню свого здоров'я і здоров'я Ваших близьких.</p>
                <p><b>З повагою, адміністрація Мед Правди.</b></p>
                <p style="text-align: center"><img src="{{asset('img/FrontBox/other/about-sertificate.png')}}" alt=""></p>
                <hr>
                <p>Ми перевіряємо інформацію спираючись на джерела:</p>
                <ul>
                ...
                <hr>
                <div class="page-row">
                    <h3 class="page-title">Редакція:</h3>
                    <div class="part">
                ...
                <div class="page-row">
                    ...
                    <div class="part">
                        ...
                        <b>Україна, м. Київ, 01010, вул. Омеляновича-Паленка, 4/6</b>
                    </div>
