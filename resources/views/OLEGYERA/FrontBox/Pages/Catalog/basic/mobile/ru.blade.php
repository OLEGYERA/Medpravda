<div class="full-content">
    <div class="page-content">
        <h1 class="page-title">
            {{$medicamentCatalog[$currentDataName]['title']}}
        </h1>
        @if(isset($alphabet))
        ...
        <div class="catalog-links-box">
            <div class="catalog-links">
                @foreach($medicamentCatalog as $key => $item)
                    <a href="{{route('m.ru.catalog.' . $item['route_name'])}}" class="catalog-link @if($key == $currentDataName) active @endif" title="{{$item['title']}}">
