        ...
        <div class="page-content">
                ...
                <div class="alphabet-rows">
                    @if(count($alphabet['num']) != 0)
                        <div class="alphabet-row">
                            <div class="alphabet-row-title">Нумерація:</div>
                    ...
                    @if(count($alphabet['let']) != 0)
                        <div class="alphabet-row">
                            <div class="alphabet-row-title">Кирилиця:</div>
                            <div class="alphabet-row-data prioritet">
                    ...
                    @if(count($alphabet['let_en']) != 0)
                        <div class="alphabet-row">
                            <div class="alphabet-row-title">Латиниця:</div>
                            <div class="alphabet-row-data">
            ...
            <div class="catalog-links">
                @foreach($medicamentCatalog as $key => $item)
                    <a href="{{route('ua.catalog.' . $item['route_name'])}}" class="catalog-link @if($key == $currentDataName) active @endif" title="{{$item['utitle']}}">
