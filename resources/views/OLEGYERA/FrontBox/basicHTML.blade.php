...
<?php
    $lang = 'ua' == Request::segment(1) ? 'ua' : 'ru';
?>
...
@if('ua' == Request::segment(1))
    <div id="cookies-alert" style="width: 100%">
        <h3 class="cookie-title">Cookie</h3>
        <div class="alert-info">
            Цей сайт використовує cookies. Ви можете змінити налаштування cookies в своєму браузері. <a href="{{route('ua.confidentiality')}}">Дізнатися більше.</a>
        </div>
        <div class="cookie-chekbox">
            <input type="checkbox" id="cookie-accept" ch-status="false">
            <label for="cookie-accept">Згоден</label>
        </div>
...
@else
    <div id="cookies-alert" style="width: 100%">
        <h3 class="cookie-title">Cookie</h3>
        <div class="alert-info">
            Этот сайт использует cookies. Вы можете изменить настройки cookies в своём браузере. <a href="{{route('ru.confidentiality')}}"> Узнать больше.</a>
        </div>
        <div class="cookie-chekbox">
            <input type="checkbox" id="cookie-accept" ch-status="false">
            <label for="cookie-accept">Согласен</label>
        </div>
        <div class="cookie-btns">
...
<script>var scr = {"scripts":[
            ...
            {"src" : "{{ asset('/js/libs/jquery.scrollbar.min.js') }}", "sync" : false},
            {"src" : "{{ asset('js/FrontBox/mp-desktop.js') }}", "sync" : false},
        ]};!function(t,n,r){"use strict";var c=function(t){if("[object Array]"!==Object.prototype.toString.call(t))return!1;for(var r=0;r<t.length;r++){var c=n.createElement("script"),e=t[r];c.src=e.src,c.async=e.async,n.body.appendChild(c)}return!0};t.addEventListener?t.addEventListener("load",function(){c(r.scripts);},!1):t.attachEvent?t.attachEvent("onload",function(){c(r.scripts)}):t.onload=function(){c(r.scripts)}}(window,document,scr);
</script>
<script src="{{ asset('js/FrontBox/reactive.js') }}"></script>
</body>
</html>
