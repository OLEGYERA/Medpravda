@if($ware->instruction_adaptive->composition && $ware->instruction_adaptive->composition !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_composition">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->composition !!}</div>
    </div>
@endif
@if($ware->instruction_adaptive->pharma_props && $ware->instruction_adaptive->pharma_props !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_pharma_props">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->pharma_props !!}</div>
    </div>
@endif
@if($ware->instruction_adaptive->indications && $ware->instruction_adaptive->indications !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_indications">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->indications !!}</div>
    </div>
@endif
@if($is_mobile ?? false)
...
@if($ware->instruction_adaptive->special_indications && $ware->instruction_adaptive->special_indications !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_indications">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->special_indications !!}</div>
    </div>
@endif
@if($ware->instruction_adaptive->contraindications && $ware->instruction_adaptive->contraindications !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_contraindications">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->contraindications !!}</div>
    </div>
@endif
@if($ware->instruction_adaptive->usage_and_dose && $ware->instruction_adaptive->usage_and_dose !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_usage_and_dose">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->usage_and_dose !!}</div>
    </div>
@endif
@if($is_mobile ?? false)
...
@if($ware->instruction_adaptive->storage_conditions && $ware->instruction_adaptive->storage_conditions !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_storage_conditions">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->storage_conditions !!}</div>
    </div>
@endif
@if($ware->instruction_adaptive->release_form && $ware->instruction_adaptive->release_form !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_release_form">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->release_form !!}</div>
    </div>
@endif
...
@if($ware->instruction_adaptive->other && $ware->instruction_adaptive->other !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_other">
        ...
        <div class="info-row" itemprop="articleSection">{!! $ware->instruction_adaptive->other !!}</div>
    </div>
@endif
