@include('OLEGYERA.FrontBox.MediaZone.Articles.modules.mobile-menu.ua')
...
<div class="full-content media-zone">
                ...
                <div class="author-info">
                    ...
                    @if($article->dependency->editor->editor)
                        <div class="author-links">
                            ...
                            @endif
                            <a target="_blank" href="{{route('ua.editors')}}/#{{$article->dependency->editor->id}}">{{$article->dependency->editor->surname}} {{$article->dependency->editor->name}}</a>
                        </div>
                    @endif
                </div>
                @if($article->dependency->editor->editor)
    ...
    @include('OLEGYERA.FrontBox.MODULES.asides.mobile.ua', ['data' => $article])
</div>
