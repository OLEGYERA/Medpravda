    ...
    <div class="main-editor-row">
        ...
        <div class="main-editor-data">
            <div class="main-editor-info">
                ...
                @if($data->creator->editor)
                    <div class="editor-links">
                        ...
                        @endif
                        <a target="_blank" href="{{route('ua.editors')}}/#{{$data->creator->id}}">{{$data->creator->surname}} {{$data->creator->name}}</a>
                    </div>
            ...
            <div class="relocate-to-editor">
                <a href="{{route('ua.editors')}}/#{{$data->creator->id}}" class="under-title">Докладніше</a>
                <link itemprop="sameAs" href="{{route('ua.editors')}}/#{{$data->creator->id}}" />
                <link itemprop="url" href="{{route('ua.editors')}}">
                <meta itemprop="name" content="Medpravda">
                <div itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
                    <link itemprop="image" href="{{asset('img/FrontBox/Logo/ua.svg')}}"/>
