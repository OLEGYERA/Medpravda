                        ...
                        <ul class="analog-box">
                            @foreach($analog_box['data'] as $analog)
                                <li class="analog-item">
                                    <a href="{{route('ru.' . $analogs['type'], ['alias' => $analog->alias])}}" title="{{$analog->title}}">{{$analog->title}}</a>
                                </li>
                            @endforeach
                        </ul>
                    @endforeach
        ...
        <div class="mp-fabricators">
            ...
            <ul class="analog-box">
                @foreach($fabricator_products['data'] as $product)
                    <li class="analog-item">
                        <a href="{{route('ru.' . $fabricator_products['type'], ['alias' => $product->alias])}}" title="{{$product->title}}">{{$product->title}}</a>
                    </li>
                @endforeach
            </ul>
        </div>
