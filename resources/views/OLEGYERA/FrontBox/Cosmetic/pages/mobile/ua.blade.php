@include('OLEGYERA.FrontBox.Cosmetic.modules.mobile-menu.ua')
...
"url": "{{ route('m.ua.cosmetic', ['alias' => $cosmetic->alias])}}",
...
<div class="full-content"
    ...
    <link itemprop="mainEntityOfPage" href="{{route('m.ua.cosmetic', ['alias' => $cosmetic->alias])}}" />
    <section class="page-content mp-anchor" id="startPage">
                ...
                <div class="author-info">
                    ...
                    @if($cosmetic->creator->editor)
                        <div class="author-links">
                            ...
                            @endif
                            <link itemprop="sameAs" href="{{route('m.ua.editors')}}/#{{$cosmetic->creator->id}}" />
                            <a target="_blank" href="{{route('m.ua.editors')}}/#{{$cosmetic->creator->id}}">{{$cosmetic->creator->surname}} {{$cosmetic->creator->name}}</a>
                        </div>
                    @endif
                </div>
                @if($cosmetic->creator->editor)
        ...
        <h1 class="drug-title" itemprop="headline name">{{$cosmetic->utitle}}</h1>
            ...
            <div class="drug-intro-dependencies">
                ...
                @if($cosmetic->dependency->fabricator)
                    <div class="mp-row-present">
                        ...
                        <div class="info-row">
                            <a href="{{route('m.ua.catalog.list.fabricator', ['val' => $cosmetic->dependency->fabricator->alias])}}" target="_blank" class="link-blank"><span class="glyph blank_link"></span></a>
                            <a href="{{route('m.ua.catalog.list.fabricator', ['val' => $cosmetic->dependency->fabricator->alias])}}" class="external-link">{{$cosmetic->dependency->fabricator->utitle}}@if($cosmetic->dependency->fabricator_location), {{$cosmetic->dependency->fabricator_location->utitle}}@endif</a>
                        </div>
                    </div>
                @endif
            </div>
    ...
    @include('OLEGYERA.FrontBox.MODULES.asides.mobile.ua', ['data' => $cosmetic, 'is_mobile' => $is_mobile])
</div>
