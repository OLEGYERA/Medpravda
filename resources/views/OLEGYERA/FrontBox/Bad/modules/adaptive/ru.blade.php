@if($bad->instruction_adaptive->composition && $bad->instruction_adaptive->composition !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_composition">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->composition !!}</div>
    </div>
@endif
...
@if($bad->instruction_adaptive->pharma_props && $bad->instruction_adaptive->pharma_props !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_pharma_props">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->pharma_props !!}</div>
    </div>
@endif
@if($bad->instruction_adaptive->indications && $bad->instruction_adaptive->indications !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_indications">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->indications !!}</div>
    </div>
@endif
@if($is_mobile ?? false)
...
@if($bad->instruction_adaptive->special_indications && $bad->instruction_adaptive->special_indications !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_individual">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->special_indications !!}</div>
    </div>
@endif
@if($bad->instruction_adaptive->contraindications && $bad->instruction_adaptive->contraindications !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_contraindications">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->contraindications !!}</div>
    </div>
@endif
@if($bad->instruction_adaptive->usage_and_dose && $bad->instruction_adaptive->usage_and_dose !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_usage_and_dose">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->usage_and_dose !!}</div>
    </div>
@endif
@if($is_mobile ?? false)
...
@if($bad->instruction_adaptive->storage_conditions && $bad->instruction_adaptive->storage_conditions !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_storage_conditions">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->storage_conditions !!}</div>
    </div>
@endif
@if($bad->instruction_adaptive->release_form && $bad->instruction_adaptive->release_form !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_release_form">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->release_form !!}</div>
    </div>
@endif
...
@if($bad->instruction_adaptive->other && $bad->instruction_adaptive->other !== '<p><br></p>')
    <div class="mp-row-present" id="adaptive_other">
        ...
        <div class="info-row" itemprop="articleSection">{!! $bad->instruction_adaptive->other !!}</div>
    </div>
@endif
