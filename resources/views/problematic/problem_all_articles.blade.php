...
<div class="wrap blue-circle">
    ...
    {{--BreadCrumbs--}}
    <h1>Статьи из раздела {{$main_category->title}}</h1>
</div>
@if(count($articles))
    <div class="two-column-articles-mini">
        @foreach($articles as $article)
            <article class="news">
                <a href="{{ route('problematic.read_article', ['alias1' => $main_alias,'article2'=>$article->alias]) }}/">
                    ...
                    <div class="article-info">
                        ...
                        <div class="article-text">{!! str_limit(strip_tags($article->content), 312) !!}</div>
                        <div class="date-link">
