    ...
    <section class="content m-top">
        ...
        <section class="section-last-arts">
                        ...
                        <div class="left-column big-news">
                            <article class="news">
                                @if(collect(request()->segments())->last() == $articles->first()->alias)
                                    <a>
                                        @else
                                            <a href="{{ route('articles', ['alias1'=>$main_alias, 'alias2'=>$articles->first()->alias]) }}/">
                                                @endif
                                                <div class="article-img">
                                                    <img src="{{ asset('asset').'/images/problematic/'.$articles->first()->image }}"
                                                         alt=""
                                                         title=""
                                                            {!! image_width_height_return_tags(asset('asset').'/images/problematic/'.$articles->first()->image) !!}
                                                    >
                                                    ...
                                                    <div class="date-link">
                                                        <div class="article-date">
                                                            {{ $articles->first()->created_at->format('d')
                                                                . ' '  . trans('ru.'.$articles->first()->created_at->format('m'))
            ...
            <div>
                    ...
                    <a href="{{ route('problematic.articles_cat', ['cat_alias'=>$main_alias]) }}/"
