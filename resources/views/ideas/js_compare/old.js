...
var idIndex = '#R7TtEmnmMq6nI6z2y6aHGI2bV1541759017' //id ссылки на первой странице;

var mah = parseInt( Math.random()*99 );
m = mah >= 1 && mah <= 17  ? true : false

var scenario = m ? [] : [["#menu-main",1000],["#menu-drugs",1000],["#menu-tops",1000],["#menu-rek",1000]];
