                        ...
                        <div class="article-img">
                            ...
                            @else
                                <img src="{{ asset('asset/images/showcase/mp-mini.jpg')}}"
                                     alt="Фото скоро з'явиться"
                                     title="Фото скоро з'явиться"
                                {!! image_width_height_return_tags(asset('asset/images/showcase/mp-mini.jpg')) !!}
                                >
                            @endif
                        </div>
                        <div class="article-info">
                            <div class="article-title">{{ $cat->alias_1[0]->uamedicine ? $cat->alias_1[0]->uamedicine->title : '' }}</div>
                        </div>
                    </a>
                </article>
            @endif
            @if(!empty($cat->alias_2[0]))
                <article class="article-products">
                    <a href="{{ route('medicine_ua', ['medicine'=>$cat->alias_2[0]->alias]) }}/">
                        ...
                        <div class="article-info">
                            <div class="article-title">{{ $cat->alias_2[0]->uamedicine->title }}</div>
                        </div>
                    </a>
                </article>
            @endif
            @if(!empty($cat->alias_3[0]))
                <article class="article-products mobile-display-none">
                    <a href="{{ route('medicine_ua', ['medicine'=>$cat->alias_3[0]->alias]) }}/">
                        ...
                        <div class="article-info">
                            <div class="article-title">{{ $cat->alias_3[0]->uamedicine->title }}</div>
                        </div>
                    </a>
                </article>
            @endif
