    ...
    <section class="content m-top">
        <div class="wrap">
            ...
            <div class="bread-crumbs breadcrumbs mobile-display-none" id="breadcrumbs"
                ...
                <div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem" class="button">
                    <a href="{{ route('ware_get_adapted', ['ware_slug'=>$faq->slug]) }}" itemprop="item">
            ...
            <div class="product-nav">
                <a href="{{ route('ware_get_official', ['ware_slug'=>$faq->slug]) }}"
                   class="nav-button-grey">
                    Официальная инструкция
                </a>
                <a href="{{ route('ware_get_adapted', ['ware_slug'=>$faq->slug]) }}"
