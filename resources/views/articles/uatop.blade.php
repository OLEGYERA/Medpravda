                        ...
                        <div class="article-img">
                            @if(!empty($prems[0]->image->path))
                                <img src="{{ asset('asset').'/images/articles/ua/main/'.$prems[0]->image->path }}"
                                    ...
                                    {!! image_width_height_return_tags(asset('asset').'/images/articles/ua/main/'.$prems[0]->image->path) !!}
                                >
                            @else
                            ...
                            <div class="article-img">
                                @if(!empty($prem->image->path))
                                    <img src="{{ asset('asset').'/images/articles/ua/middle/'.$prem->image->path }}"
                                        ...
                                        {!! image_width_height_return_tags(asset('asset').'/images/articles/ua/middle/'.$prem->image->path) !!}
                                    >
                                @else
                                    <img src="{{ asset('asset')}}/images/articles/mp.png"
                                         alt="MedPravda" title="MedPravda" width="270" height="270">
