                ...
                <div class="footer-column">
                    <div class="meta-btn-footer">
                        <div class="products item_block_three">
                            <a class="footer-item-title" href="https://medpravda.ua/fresh-articles/cat/intimnye-temy/">БОЛЕЗНИ И СИМПТОМЫ</a>
                        </div>

                        <div class="preparation item_block_one">
                            @if(Request::fullUrl().'/' == 'https://medpravda.ua/sort/farm-gruppa/')
                                <div class="footer-item-title">СПРАВОЧНИК</div>
                            @else
                                <a class="footer-item-title" href="https://medpravda.ua/sort/alfavit/">СПРАВОЧНИК</a>
                            @endif
                ...
                <div class="footer-column">
                    <div class="about item_block_one">
                        ...
                        @if('about' == Route::currentRouteName())
                            <a class="footer-item-title">О НАС</a>
                        @else
