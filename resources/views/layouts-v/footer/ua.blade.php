                ...
                <div class="footer-column">
                    <div class="meta-btn-footer">
                        <div class="products item_block_three">
                            <a class="footer-item-title" href="https://medpravda.ua/fresh-articles/cat/intimnye-temy/">ХВОРОБИ ТА СИМПТОМИ</a>
                        </div>

                        <div class="preparation item_block_one">
                            <a class="footer-item-title" href="https://medpravda.ua/ua/sort/alfavit/">ДОВІДНИК</a>
                            <ul>
        ...
        <div class="wrap_for_border">
            <div class="copy-block logo">
                @if('main' == Route::currentRouteName())
                    <img src="{{ asset('assets') }}/images/main/logo_ru.png" alt="Головний логотип Медправда" title="Головний логотип">
                @else
                    <a href="{{ route('main') }}/">
                        <img src="{{ asset('assets') }}/images/main/logo_ru.png" alt="Головний логотип Медправда" title="Головний логотип"></a>
                @endif
            </div>
