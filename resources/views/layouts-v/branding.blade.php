...
{{--<div class="body-promotion tablet">--}}
    {{--<img src="/assets/images/promotion/body-rek-tablet.jpg" alt="">--}}
{{--</div>--}}
{{--<div class="body-promotion mobile clone-from" data-number="1">--}}
    {{--<img src="/assets/images/promotion/body-rek-mob.jpg" alt="">--}}
{{--</div>--}}
<!-- end REKLAMA BODY -->

<!--  AdRiver code START. Type:AjaxJS Site: medpravda BN:3 -->
<div id="adriver_banner_86521078"></div>
<script defer async type="text/javascript">
    new adriver("adriver_banner_86521078", {sid:219776, bt:52, bn:3});
</script>
