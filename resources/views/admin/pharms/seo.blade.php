<div class="breadcrumb">
    <span>Редактирование SEO-блоков для фармгруппы</span>
</div>

{!! Form::open(['url'=>route('pharm_seo_update', $pharm->id), 'method'=>'post']) !!}<!-- SEO -->

{{--SEO FOR RUS--}}
<div class="two__column">
    <div class="wrap__block">
        <h2>{{ $pharm->title }} (SEO-RU)</h2>
        <div class="two__column">
