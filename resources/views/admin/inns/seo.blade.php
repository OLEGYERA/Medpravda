<div class="breadcrumb">
    <span>Редактирование SEO-блоков для международного названия:</span>
</div>

{!! Form::open(['url'=>route('substance_seo_update', $inn->id), 'method'=>'post', 'class'=>'form-horizontal']) !!}<!-- SEO -->

{{--SEO FOR RUS--}}
<div class="two__column"><!--две колонки-->
    <div class="wrap__block">
        <h2>{{ $inn->title }} (SEO-RU)</h2>
    ...
    <div class="wrap__block">
        ...
        <h3>SEO_TEXT</h3>
        <textarea name="seo_text" rows="20">{!! old('seo_text') ? : ($seo->useo_text ?? '') !!}</textarea>
