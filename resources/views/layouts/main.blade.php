...
<head>
    ...
    <script>
        (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: "ca-pub-5586662722957329",
...
{{--    @endif--}}
    ...
    <script>
        ...
        loadCSS("https://fonts.googleapis.com/css?family=Cormorant+Garamond:700"); //Load Libs CSS: Animate CSS
        loadCSS("{{ asset('assets') }}/css/font-awesome.min.css");
        loadCSS("{{ asset('assets') }}/css/fonts.css");
        loadCSS("{{ asset('assets') }}/css/reklama-body.css");
        loadCSS("{{ asset('assets') }}/css/slick.css");
        loadCSS("{{ asset('assets') }}/css/fresh.css");
...
<script>var scr = {"scripts":[
            {"src" : "{{ asset('assets') }}/js/slick.min.js", "async" : false},
            {"src" : "{{ asset('assets') }}/js/slider.js", "async" : false},
            {"src" : "{{ asset('assets') }}/js/accordion.js", "async" : false},
            {"src" : "{{ asset('assets') }}/js/menu.js", "async" : false},
            {"src" : "{{ asset('assets') }}/js/totop.js", "async" : false},
            {{--{"src" : "{{ asset('assets') }}/js/adriver.core.2.js", "async" : false},--}}
