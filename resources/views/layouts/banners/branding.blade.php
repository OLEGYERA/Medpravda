...
<div id="adriver_banner_1005371918" class="body-promotion"></div>
...
{{--    </script>--}}
    ...
    <script type="text/javascript">
        new adriver("adriver_banner_1005371918", {sid:221103, bt:52, bn:5});
    </script>
@else
    ...
    <script type="text/javascript">
       ...
       new adriver("adriver_banner_1005371918", {sid:221103, bt:52, bn:5, keyword: '{{$ar_key}}', custom: custom});
