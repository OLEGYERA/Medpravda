...
//  bind article in RouteServiceProvider
    ...
    // TODO edit min value in validation from 4 to 3
...
//                'alias' => 'required',
                ...
                'reg' => ['nullable', 'string', 'between:3,255'],
                'dose' => ['nullable', 'string', 'between:3,255'],
...
//                content
                'consist' => 'string|nullable|between:3,65530',
                'docs_form' => 'string|nullable|between:3,65530',
                'physicochemical_char' => 'string|nullable|between:3,65530',
                'fabricator' => 'string|nullable|between:3,65530',
                'addr_fabricator' => 'string|nullable|between:3,65530',
                'pharm_group' => 'string|nullable|between:3,16777214',
                'indications' => 'string|nullable|between:3,16777214',
                'pharm_prop' => 'string|nullable|between:3,16777214',
                'contraindications' => 'string|nullable|between:3,65530',
                'security' => 'string|nullable|between:3,65530',
                'application_features' => 'string|nullable|between:3,16777214',
                'pregnancy' => 'string|nullable|between:3,65530',
                'cars' => 'string|nullable|between:3,65530',
                'children' => 'string|nullable|between:3,65530',
                'app_mode' => 'string|nullable|between:3,16777214',
                'overdose' => 'string|nullable|between:3,65530',
                'side_effects' => 'string|nullable|between:3,16777214',
                'shelf_life' => 'string|nullable|between:3,65530',
                'saving' => 'string|nullable|between:3,65530',
                'packaging' => 'string|nullable|between:3,65530',
                'leave_cat' => 'string|nullable|between:3,65530',
                'interaction' => 'string|nullable|between:3,16777214',
                'additionally' => 'string|nullable|between:3,16777214',
...
//                content
            ...
            $rules = [
                'value' => ['nullable', 'string', 'between:1,255', "regex:#^[a-zA-zа-яА-ЯёЁіІїЇэєЄЭ0-9\(\)\-\s\,\:\?\!\.\']+$#u"],
