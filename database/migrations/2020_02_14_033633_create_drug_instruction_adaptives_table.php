...
class CreateDrugInstructionAdaptivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drug_instruction_adaptives', function (Blueprint $table) {
    ...
    {
        Schema::table('drug_instruction_adaptives', function (Blueprint $table) {
            $table->dropForeign('drug_instruction_adaptives_drug_id_foreign');
        });
        Schema::dropIfExists('drug_instruction_adaptives');
    }
}
