...
class CreateBadInstructionAdaptivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bad_instruction_adaptives', function (Blueprint $table) {
    ...
    {
        Schema::table('bad_instruction_adaptives', function (Blueprint $table) {
            $table->dropForeign('bad_instruction_adaptives_bad_id_foreign');
        });
        Schema::dropIfExists('bad_instruction_adaptives');
    }
}
