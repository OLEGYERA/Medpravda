...
class CreateDrugInstructionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drug_instructions', function (Blueprint $table) {
    ...
    {
        Schema::table('drug_instructions', function (Blueprint $table) {
            $table->dropForeign('drug_instructions_drug_id_foreign');
        });
        Schema::dropIfExists('drug_instructions');
    }
}
