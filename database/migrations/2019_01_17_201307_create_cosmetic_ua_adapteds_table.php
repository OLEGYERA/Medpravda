...
class CreateCosmeticUaAdaptedsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cosmetic_ua_adapteds', function (Blueprint $table) {
            $table->increments('id');
...
//      Content
    ...
    {
        Schema::dropIfExists('cosmetic_ua_adapteds');
    }
}
