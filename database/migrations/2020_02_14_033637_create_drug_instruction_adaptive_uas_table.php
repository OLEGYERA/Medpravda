...
class CreateDrugInstructionAdaptiveUasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('drug_instruction_adaptive_uas', function (Blueprint $table) {
    ...
    {
        Schema::table('drug_instruction_adaptive_uas', function (Blueprint $table) {
            $table->dropForeign('drug_instruction_adaptive_uas_drug_id_foreign');
        });
        Schema::dropIfExists('drug_instruction_adaptive_uas');
    }
}
