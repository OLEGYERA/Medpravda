...
class CreateMediaArticleContentRusTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('media_article_content_rus', function (Blueprint $table) {
    ...
    {
        Schema::table('media_article_content_rus', function (Blueprint $table) {
            $table->dropForeign('media_article_content_rus_id_foreign');
        });
        Schema::dropIfExists('media_article_content_rus');
    }
}
