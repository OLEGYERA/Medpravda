...
class CreateBadInstructionAdaptiveUasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bad_instruction_adaptive_uas', function (Blueprint $table) {
    ...
    {
        Schema::table('bad_instruction_adaptive_uas', function (Blueprint $table) {
            $table->dropForeign('bad_instruction_adaptive_uas_bad_id_foreign');
        });
        Schema::dropIfExists('bad_instruction_adaptive_uas');
    }
}
