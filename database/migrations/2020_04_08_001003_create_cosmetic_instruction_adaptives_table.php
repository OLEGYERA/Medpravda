...
class CreateCosmeticInstructionAdaptivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cosmetic_instruction_adaptives', function (Blueprint $table) {
    ...
    {
        Schema::table('cosmetic_instruction_adaptives', function (Blueprint $table) {
            $table->dropForeign('cosmetic_instruction_adaptives_cosmetic_id_foreign');
        });
        Schema::dropIfExists('cosmetic_instruction_adaptives');
    }
}
