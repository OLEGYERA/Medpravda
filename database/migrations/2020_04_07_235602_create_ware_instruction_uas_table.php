...
class CreateWareInstructionUasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ware_instruction_uas', function (Blueprint $table) {
    ...
    {
        Schema::table('ware_instruction_uas', function (Blueprint $table) {
            $table->dropForeign('ware_instruction_uas_ware_id_foreign');
        });
        Schema::dropIfExists('ware_instruction_uas');
    }
}
